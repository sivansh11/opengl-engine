...
std::unique_ptr<Material> Model::processMaterial(aiMaterial *material) {
    ...
    auto diffuseMap = loadMaterialTexture(material, aiTextureType_DIFFUSE, "diffuse");
    mat->assign("material.diffuseMap", diffuseMap);

    auto normalMap = loadMaterialTexture(material, aiTextureType_NORMALS, "normal");
    mat->assign("material.normalMap", normalMap);
